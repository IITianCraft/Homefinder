    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('notification_type', models.CharField(choices=[('meeting_request', 'Meeting Request'), ('meeting_response', 'Meeting Response'), ('announcement', 'Announcement')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            options={
                'unique_together': {('event_place', 'booking_date', 'start_time', 'end_time')},
            },
        ),
        migrations.CreateModel(
            name='MeetingRequest',
